      ...
      <div className="h-screen mt-96">
        ...
        <div className="warrper1">
          ...
          <div className="items1 item1">
            <Image  src={comment1} className="object-fit rounded-lg"/>
          </div>

          <div className="items1 item2">
            <Image  src={comment2} className="object-fit rounded-lg"/>
          </div>

          <div className="items1 item3">
            <Image  src={comment3} className="object-fit rounded-lg"/>
          </div>

          <div className="items1 item4">
            <Image  src={comment4} className="object-fit rounded-lg"/>
          </div>
        </div>

        <div  className="warrper2">
        <div className="items2 item5">
            <Image  src={comment5} className="object-fit rounded-lg"/>
          </div>

          <div className="items2 item6">
            <Image  src={comment6} className="object-fit rounded-lg"/>
          </div>

          <div className="items2 item7">
            <Image  src={comment7} className=" object-fit rounded-lg"/>
          </div>

          <div className="items2 item8">
            <Image  src={comment8} className="object-fit rounded-lg"/>
          </div>
