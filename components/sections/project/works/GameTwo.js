      ...
      <div className="gol">
        <div className="mx-4 lg:mx-20">
          <div className="works-title mb-36 text-center">
            <h1 className="pt-36 py-auto font-bold text-6xl">Game Info</h1>
            <p className="mt-8 tracking-widest text-2xl">
              Stories and information about champions
            </p>
          </div>
          <div className="bg-game p-2 lg:p-16">
            ...
            <div className="clip-btn shadow shadow-2xl flex items-center gap-2 justify-center text-center my-12 bg-zinc-800 w-4/5 lg:w-3/4 p-4 mx-auto rounded-2xl">
              <a
                ...
                href="https://gaming2-nine.vercel.app/"
                target="_blank"
              >
            ...
            <div className="my-20 px-6 lg:pl-12">
              ...
              <p className="text-xl tracking-normal leading-relaxed">
                In this project, we are researching a famous game called League
                of Legends and we are providing special information to people
                who can find and read the desired story and information about
                their favorite champion. This site uses up-to-date tools such as
                Taillwind and Alpine, which you can see more in the tools
                section.s
              </p>
            </div>
            <hr className=" border-gray-500" />
            ...
            <div className="my-20 px-6 lg:pl-12">
              ...
              <p className="text-xl">Taillwind / Alpine.js / AOS</p>
            </div>
            <hr className=" border-gray-500" />
            {/* Links */}
            <div className="my-20 px-6 lg:pl-12">
            ...
            <div className="flex items-center gap-4 links-work px-8 pb-8">
              ...
              <div className="flex flex-col items-center">
                <a
                  href="https://github.com/Aliyamash/Gaming2"
                  target="_blank"
