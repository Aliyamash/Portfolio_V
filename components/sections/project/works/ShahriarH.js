...
export default function ShahriarH() {
      ...
      <div className="gol">
        <div className="mx-20">
          <div className="works-title mb-36 text-center">
            <h1 className="pt-36 py-auto font-bold text-6xl">ShahriarH Portfolio</h1>
          ...
          <div className="bg-game p-16">
            ...
            <div className="clip-btn shadow shadow-2xl flex items-center gap-2 justify-center text-center my-12 bg-zinc-800 w-3/4 p-4 mx-auto rounded-2xl">
              <a
                ...
                href="https://github.com/Aliyamash/shahriarH"
                target="_blank"
              >
            ...
            <div className="my-20 pl-12  w-3/4">
              ...
              <p className="text-xl tracking-normal leading-relaxed">
                Converting a WordPress theme to coding and building a personal
                website that includes individual skills and portfolio, education
                and work experience, plus adding a feature at the end of the
                project to get recommendations for building different types of
                websites for the client. Modern tools such as Taillwind and Next.js
                are used in this project, and the backend of the project is
                built with Django. For more information, you can refer to the
                project and tools section of GitHub
              </p>
            </div>
            <hr className=" border-gray-500" />
            {/* project Tools */}
            <div className="my-20 pl-12">
              ...
              <p className="text-xl">Taillwind / Next.js / jango / AOS / Swiper.js</p>
            </div>
            <hr className=" border-gray-500" />
            {/* Links */}
            <div className="my-20 pl-12">
            ...
            <div className="flex items-center gap-4 links-work px-8 pb-8">
              <div className="flex flex-col items-center">
                <a
                  href="https://github.com/SupportShTeam/shwebsite"
                  target="_blank"
