      ...
      <div className="gol">
        <div className="mx-4 lg:mx-20">
          <div className="works-title mb-36 text-center">
            <h1 className="pt-36 py-auto font-bold text-6xl">BasketShop</h1>
            <p className="mt-8 tracking-widest text-2xl">Save your purchases</p>
          </div>
          <div className="bg-game p-2 lg:p-16">
            ...
            <div className="clip-btn shadow shadow-2xl flex items-center gap-2 justify-center text-center my-12 bg-zinc-800 w-4/5 lg:w-3/4 p-4 mx-auto rounded-2xl">
              <a
                ...
                href="https://shopping-cart-bice-psi.vercel.app/"
                target="_blank"
              >
            ...
            <div className="my-20 px-6 lg:pl-12">
              ...
              <p className="text-xl tracking-normal leading-relaxed">
                Shopping cart project, plan for all the products you want and
                categorize and buy them. This project is designed with the
                latest technology such as React and Redux. For more information,
                you can refer to the project's site and GitHub page
              </p>
            </div>
            <hr className=" border-gray-500" />
            {/* project Tools */}
            <div className="my-20 px-6 lg:pl-12">
              ...
              <p className="text-xl">javaScript / React / Redux</p>
            </div>
            <hr className=" border-gray-500" />
            {/* Links */}
            <div className="my-20 px-6 lg:pl-12">
            ...
            <div className="flex items-center gap-4 links-work px-8 pb-8">
              ...
              <div className="flex flex-col items-center">
                <a
                  href="https://github.com/Aliyamash/Shopping-Cart"
                  target="_blank"
                  className="icon-project shadow-2xl bg-zinc-800 w-fit p-3 mt-4 mb-1 rounded-full"
                >
                  <svg
