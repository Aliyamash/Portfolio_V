          ...
          <div className="bg-game p-16">
            ...
            <div className="my-20 pl-12  w-3/4">
              ...
              <p className="text-xl tracking-normal leading-relaxed">
                ...
                the employer and modern tools such as Redux. In this project,
                you can order food online. For more information, refer to the
                project's Tools and GitHub section
              </p>
            </div>
            <hr className=" border-gray-500" />
            {/* project Tools */}
