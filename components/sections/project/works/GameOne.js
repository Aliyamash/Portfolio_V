          ...
          <div className="bg-game p-16">
            ...
            <div className="my-20 pl-12  w-3/4">
              ...
              <p className="text-xl tracking-normal leading-relaxed">
                ...
                their game accounts . This is my first project and I was able to
                complete this project using front end tools . It should be noted
                that this project is completely responsive and can be used for
                phones
              </p>
            </div>
            <hr className=" border-gray-500" />
            ...
            <div className="my-20 pl-12">
              ...
              <div className="flex items-center gap-4 links-work px-8 pb-8">
                ...
                <div className="flex flex-col items-center">
                <a href="https://github.com/Aliyamash/Gaming" target="_blank" className="icon-project shadow-2xl bg-zinc-800 w-fit p-3 mt-4 mb-1 rounded-lg">
                  <svg
