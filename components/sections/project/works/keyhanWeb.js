...
export default function KeyhanWeb() {
          ...
          <div className="bg-game p-16">
            ...
            <div className="my-20 pl-12  w-3/4">
              ...
              <p className="text-xl tracking-normal leading-relaxed">
                ...
                galaxy Love them and own them There is also a gallery of all
                kinds of stars and galaxies on this site, which you can access
                to the main site using the links provided for you. It should be
                noted that Responsiveness and Flex technology are used in this
                project and you can see more in the tool section.
              </p>
            </div>
            <hr className=" border-gray-500" />
            {/* project Tools */}
            ...
            <div className="flex items-center gap-4 links-work px-8 pb-8">
              ...
              <div className="flex flex-col items-center">
                <a
                  href="https://github.com/Aliyamash/KeyhanWeb"
                  target="_blank"
